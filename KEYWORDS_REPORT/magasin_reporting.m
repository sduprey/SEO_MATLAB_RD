function  magasin_reporting(current_magasin,my_concurrent,conn)
...
for conc=1:length(my_concurrent)
    ...
    % getting real data
    my_string=['select * from pricing_keywords where magasin = ''' current_magasin ''' and domain =''' current_conc ''''];
