...
entity_to_keep=1:10;
% normalizing data
coverage_rate_per_entity_per_magasin(:,20) = coverage_rate_per_entity_per_magasin(:,20)./4;
normalizing_factor = repmat((100./sum(coverage_rate_per_entity_per_magasin,2)),1,size(coverage_rate_per_entity_per_magasin,2));
