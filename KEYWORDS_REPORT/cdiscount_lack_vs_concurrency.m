%% Mots clés où la concurrence est et où nous ne sommes pas
...
my_entity = {'cdiscount.com';'aubert.com';'autourdebebe.com';'king-jouet.com';'toysrus.fr';'materiel.net';'pearl.fr';'amazon.fr';'ebay.fr';'rueducommerce.fr';'conforama.fr';'darty.com';'fnac.com';'priceminister.com';'zalando.fr';'ldlc.com';'boulanger.fr';'french.alibaba.com';'pixmania.fr'}; %#ok<NASGU>
...
%% JEUX-PC-VIDEO-CONSOLE reporting
...
%% BIJOUTERIE reporting
current_magasin='bijouterie';
magasin_keywords_reporting(current_magasin,my_entity,conn);

%% AU-QUOTIDIEN reporting
...
my_entity = {'cdiscount.com';'aubert.com';'autourdebebe.com';'king-jouet.com';'toysrus.fr';'materiel.net';'pearl.fr';'amazon.fr';'ebay.fr';'rueducommerce.fr';'conforama.fr';'darty.com';'fnac.com';'priceminister.com';'zalando.fr';'ldlc.com';'boulanger.fr';'french.alibaba.com';'pixmania.fr'};
magasin_keywords_reporting(current_magasin,my_entity,conn);
